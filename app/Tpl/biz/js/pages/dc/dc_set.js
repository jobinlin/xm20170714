$(function(){
	...
	var package_start_price=parseFloat($("input[name='package_start_price']").val())?parseFloat($("input[name='package_start_price']").val()):0;
	
	if(package_start_price==0){
		$("#package_price").hide();
		$("input[name='package_price']").val('');
	}
	
	$("input[name='package_start_price']").change(function(){
		var start_price=parseFloat($(this).val())?parseFloat($(this).val()):0;
...
function add_delivery_row(){
	var html = '<div class="delivery_item"><span style="padding-left: 50px;"><input style="width:50px;" class="pricebox" name="scale[]"/>&nbsp;公里之内'
		+'&nbsp;&nbsp;起送费&nbsp;<input class="pricebox" style="width:50px;" name="start_price[]"/>&nbsp;元'
		+'&nbsp;&nbsp;配送费&nbsp;<input class="pricebox" style="width:50px;" name="delivery_price[]"/>&nbsp;元</span>'
