...
class gc_schedule {
	...
	public function exec($data){
		...
		//关闭未付款的定单(20分钟)
		$order_list = $GLOBALS['db']->getAll("select * from ".DB_PREFIX."deal_order where is_delete=0 and type !=3 and pay_status = 0 and update_time < ".(NOW_TIME-1200)." order by update_time asc limit 20");
