...
class AppTemplate
{
    ...
    {
    	if(IS_DEBUG)
        $this->_errorlevel = E_ALL^E_DEPRECATED^E_STRICT^E_NOTICE^E_WARNING;//$this->_errorlevel = E_ALL^E_NOTICE^E_WARNING^E_DEPRECATED^E_STRICT;
        else 
        $this->_errorlevel = 0;
        $this->_nowtime    = time();
