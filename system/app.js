...
start_cron("order","__HOST__",80,"__APP_ROOT__/cron.php",3000,{"auth":"__TYPE_ORDER__"});
start_cron("dc_order","__HOST__",80,"__APP_ROOT__/cron.php",3000,{"auth":"__TYPE_DC_ORDER__"});
