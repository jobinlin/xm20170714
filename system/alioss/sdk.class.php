...
class ALIOSS{
	...
	public function auth($options){
        ...
        $this->request_url = str_replace($options[self::OSS_BUCKET]."/","",$this->request_url);
		$msg .= "--REQUEST URL:----------------------------------------------\n".$this->request_url."\n";
		...
		// 这个原本链接OSS_BUCKET，只有/OSS_BUCKET, 测试用户需要/OSS_BUCKET/OSS_BUCKET, 如果发现签名错误，可以删掉一个OSS_BUCKET测试
