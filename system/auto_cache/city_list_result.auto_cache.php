...
class city_list_result_auto_cache extends auto_cache{
	...
	public function load($param)
	{
		...
		{
			$city_list = $GLOBALS['db']->getAll("select id,name,pid,uname,is_open,left(uname,1) as zm from ".DB_PREFIX."deal_city where is_effect = 1 and is_delete = 0 and pid > 0  order by left(uname,1) asc,sort desc");
			$city_zm_list = array();
			$ccity_list = array();
