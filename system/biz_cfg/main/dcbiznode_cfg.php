...
return array(
			"DcOrder"	=>	array(
					...
					"node"	=>	array(
					        ...
					        "dcxorder"=>array("name"=>"异常订单","module"=>"dcxorder","action"=>"index"),
			...
			"Location"	=>	array(
					...
					"node"	=>	array(
					        ...
					        "delivery_setting"=>array("name"=>"配送设置","module"=>"delivery_setting","action"=>"index"),
					        "delivery_setting"=>array("name"=>"配送设置","module"=>"delivery_setting","action"=>"dada_acount"),
