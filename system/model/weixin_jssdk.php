...
function getWxObject(){
    ...
    $option = array(
        'appid'=>$weixin_conf['platform_appid'],
        'appsecret'=>$weixin_conf['platform_appsecret'],
        'token'=>$weixin_conf['platform_token'],
        'encodingAesKey'=>$weixin_conf['platform_encodingAesKey'],
        'debug'=>false,
    );
    require_once APP_ROOT_PATH."system/wechat/wechat.class.php";
