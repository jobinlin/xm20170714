...
class initApiModule extends MainBaseApiModule
{
	...
	public function index()
	{
		...
		$root = array();
        if($sdk_version == 'android'){
            $root['serverVersion'] = $GLOBALS['m_config']['android_version'];//android版本号
            $root['android_biz_filename'] = $GLOBALS['m_config']['android_biz_filename'];
            $root['android_biz_forced_upgrade'] = $GLOBALS['m_config']['android_biz_forced_upgrade'];
            $root['android_biz_upgrade'] = $GLOBALS['m_config']['android_biz_upgrade'];
            $root['android_version'] = $GLOBALS['m_config']['android_version'];
            $root['android_filename'] = $GLOBALS['m_config']['android_filename'];
            $root['android_upgrade'] = $GLOBALS['m_config']['android_upgrade'];
            $root['android_forced_upgrade'] = $GLOBALS['m_config']['android_forced_upgrade'];
            $root['android_biz_master_secret'] = $GLOBALS['m_config']['android_biz_master_secret'];
            $root['android_biz_app_key'] = $GLOBALS['m_config']['android_biz_app_key'];
            $root['android_master_secret'] = $GLOBALS['m_config']['android_master_secret'];
            $root['android_app_key'] = $GLOBALS['m_config']['android_app_key'];
            $root['android_dist_version'] = $GLOBALS['m_config']['android_dist_version'];
            $root['android_dist_down_url'] = $GLOBALS['m_config']['android_dist_down_url'];
            $root['android_dist_upgrade'] = $GLOBALS['m_config']['android_dist_upgrade'];
            $root['android_dist_forced_upgrade'] = $GLOBALS['m_config']['android_dist_forced_upgrade'];
		}else if ($sdk_version == 'ios'){
		    $root['serverVersion'] = $GLOBALS['m_config']['ios_version'];//ios版本号
            $root['ios_forced_upgrade'] = $GLOBALS['m_config']['ios_forced_upgrade'];
            $root['is_ios_upgrading'] = $GLOBALS['m_config']['is_ios_upgrading'];
            $root['ios_down_url'] = $GLOBALS['m_config']['ios_down_url'];
            $root['ios_upgrade'] = $GLOBALS['m_config']['ios_upgrade'];
            $root['ios_biz_version'] = $GLOBALS['m_config']['ios_biz_version'];
            $root['ios_biz_down_url'] = $GLOBALS['m_config']['ios_biz_down_url'];
            $root['ios_biz_upgrade'] = $GLOBALS['m_config']['ios_biz_upgrade'];
            $root['ios_biz_app_key'] = $GLOBALS['m_config']['ios_biz_app_key'];
            $root['ios_biz_master_secret'] = $GLOBALS['m_config']['ios_biz_master_secret'];
            $root['ios_app_key'] = $GLOBALS['m_config']['ios_app_key'];
            $root['ios_master_secret'] = $GLOBALS['m_config']['ios_master_secret'];
            $root['ios_dist_version'] = $GLOBALS['m_config']['ios_dist_version'];
            $root['ios_dist_down_url'] = $GLOBALS['m_config']['ios_dist_down_url'];
            $root['ios_dist_upgrade'] = $GLOBALS['m_config']['ios_dist_upgrade'];
            $root['ios_dist_forced_upgrade'] = $GLOBALS['m_config']['ios_dist_forced_upgrade'];
        ...
        //返回手机端URL 白名单
        $root['app_url_white_list_cfg'] = json_encode(require APP_ROOT_PATH."system/mobile_cfg/app_url_white_list_cfg.php");
