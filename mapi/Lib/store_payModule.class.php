...
class store_payApiModule extends MainBaseApiModule {
    ...
    public function pay() {
        ...
        */
        ...
        //获取促销规则 (重新编辑)
        $sql = 'SELECT p.* from '.DB_PREFIX.'promote p inner join '.DB_PREFIX.'supplier_location sl on p.supplier_id=sl.supplier_id AND sl.id='.$location_id.' WHERE sl.open_store_payment = 1';
