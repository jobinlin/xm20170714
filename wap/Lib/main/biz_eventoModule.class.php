...
class biz_eventoModule extends MainBaseModule
{
	public function index()
	{
		...
		$data = call_api_core("biz_evento","index",$param);
	...
	public function events()
	{
	    ...
	    $data = call_api_core("biz_evento","events",$param);
	...
	public function approval()	{
		...
		init_app_page();		
		$param['data_id'] = intval($_REQUEST['data_id']);
		$data = call_api_core("biz_evento","approval",$param);
	...
	public function refuse()	{
		...
		init_app_page();		
		$param['data_id'] = intval($_REQUEST['data_id']);
		$data = call_api_core("biz_evento","refuse",$param);
