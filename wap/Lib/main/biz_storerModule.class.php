...
class biz_storerModule extends MainBaseModule
{
	public function index()
	{
		...
		$data = call_api_core("biz_storer","index");
	...
	public function storer_dp_list(){
	    ...
	    $data = call_api_core("biz_storer","storer_dp_list",$param);
	...
	public function storer_reply_dp(){
	    ...
	    init_app_page();
	    $param['data_id'] = intval($_REQUEST['data_id']); //分类ID
	    $data = call_api_core("biz_storer","storer_reply_dp",$param);
	...
	public function do_reply_dp(){
	    ...
	    $data = call_api_core("biz_storer","do_reply_dp",$param);
