				...
				success:function(data){
					if(data.status==1){
						...
						location.href=location.href;
							...
							if(data.act=='cancel'){
						var html = "<div id='light' class='white_content'><div>"+data.info+"</div>";
							html+="<a class='f_l mar_tb_20 w180 h067 lh064 tc f_fff  f036  bdr3 bg_fe4d3d' href='tel:"+data.location_tel+"'>拨号</a>"
							html+="<a class='f_r mar_tb_20 w180 h067 lh064 tc f_fff  f036  bdr3 bg_DAD8D6' id='cloesd_tel'>取消</a>"
							html+="</div>";		
							...
							//关闭拨号窗口
								$('#cloesd_tel').bind('click',function(){
